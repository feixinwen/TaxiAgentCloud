package com.fancy.taxiagent.rag.filter;
...
/**
 * 为 Rag Service 的 HTTP 请求传播或生成追踪标识，并记录请求边界日志。
 */
@Component
...
public class RequestTraceFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        log.info(
                "event=rag_http_request_started traceId={} method={} path={}",
                traceId,
                request.getMethod(),
        ...
        try {
            ...
            log.info(
                    "event=rag_http_request_finished traceId={} method={} path={} status={} durationMs={}",
                    traceId,
                    request.getMethod(),
                    request.getRequestURI(),
                    response.getStatus(),
