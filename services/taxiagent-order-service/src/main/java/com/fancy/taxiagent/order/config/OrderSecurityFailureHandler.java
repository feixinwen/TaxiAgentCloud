...
/**
 * 记录 Order Service 的认证与授权拒绝事件，并委托 Spring Security 返回标准 401/403 响应。
 *
 * <p>拒绝日志不包含 Authorization 请求头或 Token 内容，避免凭证进入日志系统。</p>
 */
@Component
public class OrderSecurityFailureHandler implements AuthenticationEntryPoint, AccessDeniedHandler {

    private static final Logger log = LoggerFactory.getLogger(OrderSecurityFailureHandler.class);
