...
/**
 * 为 Agent Service 的 HTTP 请求传播或生成追踪标识，并记录请求边界日志。
 */
@Component
...
public class RequestTraceFilter extends OncePerRequestFilter {
    ...
    /**
     * 传播安全 TraceId，记录请求边界并确保线程复用前清理 MDC。
     */
    @Override
    protected void doFilterInternal(
        ...
        log.info(
                "event=agent_http_request_started traceId={} method={} path={}",
                traceId,
                request.getMethod(),
        ...
        try {
            ...
            log.info(
                    "event=agent_http_request_finished traceId={} method={} path={} status={} durationMs={}",
                    traceId,
                    request.getMethod(),
                    request.getRequestURI(),
                    response.getStatus(),
